    ...
    <div class="row align-items-center gy-5">
        ...
        <div class="col-md-8 col-lg-6 offset-lg-1">
            <p>
                ...
                couvrant la création de sites web et d'applications.<br>
            ...
            <p>
                La constante évolution des technologies dans ce domaine me passionne, ce qui me pousse à une formation
                continue afin de rester à la pointe.
                Je vous invite à consulter <a href="https://www.deefuse.fr" target="_blank">mon site professionnel</a> pour
                découvrir mes projets web.
            </p>
            <p class="text-end"><small>Aurélien Chappard</small></p>
        </div>
    </div>
    <a href="#experiences" class="arrow-down-link d-none d-md-block" title="Section suivante"><span>Aller à la section suivante</span></a>
</section>
